...
do
    ...
    echo "Scraping shuffled replays for rep: ${ZERO_PADDED_MAIN_ID}"

    # Create our output file
    REP_DIR=../reps/${ZERO_PADDED_MAIN_ID}
    mkdir -p ${REP_DIR}
    FILENAME_PREFIX=combined_shuffled_replay_cross_data
    CROSS_INFO_FILE=${REP_DIR}/${FILENAME_PREFIX}.csv
    printf "" > ${CROSS_INFO_FILE}

    REPLAY_DIR=${SCRATCH_EXP_DIR}/reps/${ZERO_PADDED_MAIN_ID}/shuffled_replays
